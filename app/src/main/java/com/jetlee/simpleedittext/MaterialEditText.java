...
public class MaterialEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    private static final float LABEL_SIZE = Utils.dpToPx(12);
    private static final float LABEL_PADDING = Utils.dpToPx(8);
    private static final float LABEL_OFFSET = Utils.dpToPx(4);
    private static final float LABEL_OFFSET_Y = Utils.dpToPx(12);
    private static final float TOTAL_EXTRA_OFFSET = Utils.dpToPx(16);
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(LABEL_OFFSET + 200, getBottom() - Utils.dpToPx(8), getWidth() - LABEL_OFFSET, getBottom() - Utils.dpToPx(8), paint);
    }
}
